...
- 成果物は [ER図](../skills/pm-phase5-er-diagram/SKILL.md)、[システム構成図](../skills/pm-phase5-system-architecture/SKILL.md)、[APIインターフェース定義](../skills/pm-phase5-api-interface-schema/SKILL.md) を作る。
